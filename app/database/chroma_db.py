...
class ChromaDBManager:
    """ChromaDB vector store manager with COSINE DISTANCE"""
    ...
    def initialize(self):
        ...
        try:
            ...
            try:
                ...
                logger.info(f"Created new collection with COSINE distance: {self.collection_name}")
    ...
    def query(
        ...
        Returns:
            Query results with cosine distances
        """
        if not self._initialized:
            self.initialize()
    ...
    def recreate_collection(self):
        """Delete and recreate collection with COSINE distance"""
        try:
        ...
        logger.info(f"Recreated collection with COSINE distance: {self.collection_name}")
